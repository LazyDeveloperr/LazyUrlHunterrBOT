...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/2b160d9765fe080c704d2.png",
                                ...
                                reply_markup=InlineKeyboardMarkup([
                                    ...
                                    [InlineKeyboardButton("⚡️ LazyDeveloper ⚡️", url="https://t.me/Skcreator_7")],
...
async def help_handler(_, event: Message):
    ...
    await event.reply_text(Config.ABOUT_HELP_TEXT.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Updates", url="https://t.me/Skcreator_7"),
             InlineKeyboardButton("Support Group", url="https://t.me/Skcreator7"), 
             InlineKeyboardButton("About", callback_data="About_msg")]
        ])
    )
...
async def button(bot, cmd: CallbackQuery):
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Updates Channel", url="https://t.me/Skcreator_7")
					],
					[
						InlineKeyboardButton("Connect Admin", url="https://t.me/Skcreator7"),
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[   InlineKeyboardButton("Help", callback_data="Help_msg"),
						InlineKeyboardButton("Updates Channel", url="https://t.me/Skcreator7")
					], 
                    [
						InlineKeyboardButton("Connect Admin", url="https://t.me/Skcreator_7"),
						InlineKeyboardButton("🏠Home", callback_data="gohome")
					]
				]
			),
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						InlineKeyboardButton("Support Channel", url="https://t.me/Skcreator7"),
					]
				]
			),
			parse_mode="html"
